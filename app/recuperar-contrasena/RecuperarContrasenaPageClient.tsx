...
export default function RecuperarContrasenaPageClient() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!baseUrl) {
        throw new Error("No se pudo preparar la recuperación de contraseña.");
      }
      ...
      setSuccessMessage(
        "Te hemos enviado un correo para recuperar la contraseña. Revisa tu bandeja de entrada y también el spam."
      );
    } catch (error) {
      const message =
